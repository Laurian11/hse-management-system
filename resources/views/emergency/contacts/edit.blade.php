    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            <div class="flex items-center space-x-3">
                <a href="{{ route('emergency.contacts.show', $contact) }}" class="text-gray-500 hover:text-black">
                    <i class="fas fa-arrow-left mr-2"></i>Back
                </a>
                <h1 class="text-2xl font-bold text-black">Edit Emergency Contact</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <form action="{{ route('emergency.contacts.update', $contact) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white border border-gray-300 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="contact_type" name="contact_type" required value="{{ old('contact_type', $contact->contact_type) }}"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                    @error('contact_type')
                        <p class="mt-1 text-sm text-[#CC0000]">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" id="phone_primary" name="phone_primary" required value="{{ old('phone_primary', $contact->phone_primary) }}"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                    @error('phone_primary')
                        <p class="mt-1 text-sm text-[#CC0000]">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <input type="text" id="phone_secondary" name="phone_secondary" value="{{ old('phone_secondary', $contact->phone_secondary) }}"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                </div>
                ...
                <div>
                    ...
                    <input type="text" id="specialization" name="specialization" value="{{ old('specialization', $contact->specialization) }}"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                </div>

                <div>
                    <label for="priority" class="block text-sm font-medium text-black mb-1">Priority (1-10)</label>
                    <input type="number" id="priority" name="priority" min="1" max="10" value="{{ old('priority', $contact->priority) }}"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="address" name="address" rows="2"
                              class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">{{ old('address', $contact->address) }}</textarea>
                </div>

                <div class="md:col-span-2">
                    <label for="availability" class="block text-sm font-medium text-black mb-1">Availability</label>
                    <input type="text" id="availability" name="availability" value="{{ old('availability', $contact->availability) }}"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="notes" name="notes" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">{{ old('notes', $contact->notes) }}</textarea>
                </div>
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('emergency.contacts.show', $contact) }}" class="px-6 py-2 border border-gray-300 hover:bg-[#F5F5F5]">Cancel</a>
