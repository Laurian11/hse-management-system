                ...
                <div>
                    ...
                    <select id="direct_supervisor_id" name="direct_supervisor_id"
                        ...
                        @foreach($supervisors as $supervisor)
                            <option value="{{ $supervisor->id }}" {{ old('direct_supervisor_id') == $supervisor->id ? 'selected' : '' }}>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="employment_type" name="employment_type" required
                        ...
                        <option value="visitor" {{ old('employment_type') == 'visitor' ? 'selected' : '' }}>Visitor</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="date" id="date_of_hire" name="date_of_hire" value="{{ old('date_of_hire') }}"
                           class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    @error('date_of_hire')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
