...
@section('title', 'Risk Assessment Reports')
...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <h1 class="text-2xl font-bold text-gray-900">Risk Assessment Reports</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <!-- Department Report -->
            <a href="{{ route('risk-assessment.reports.department') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow block">
                ...
                <p class="text-sm text-gray-600">View risk assessment statistics by department with day, week, month, and annual reports.</p>
            ...
            <!-- Employee Report -->
            <a href="{{ route('risk-assessment.reports.employee') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow block">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-sm text-gray-600">Track individual employee risk assessment creation and assignment statistics.</p>
            ...
            <!-- Period Report -->
            <a href="{{ route('risk-assessment.reports.period') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow block">
                <div class="flex items-center justify-between mb-4">
            ...
            <!-- Companies Report -->
            <a href="{{ route('risk-assessment.reports.companies') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow block">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-sm text-gray-600">Compare risk assessment performance across parent and sister companies.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Filter by date range, department, employee, risk level, and more</p>
                    </div>
                </div>
            </div>
        </div>
