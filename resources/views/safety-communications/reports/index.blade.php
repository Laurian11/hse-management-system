...
@section('title', 'Safety Communication Reports')
...
<div class="min-h-screen bg-gray-50">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center py-4">
                <div class="flex items-center space-x-3">
                    ...
                    <h1 class="text-2xl font-bold text-gray-900">Safety Communication Reports</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <!-- Department Report -->
            <a href="{{ route('safety-communications.reports.department') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow">
                ...
                <p class="text-sm text-gray-600">View communication statistics by department with filtering options.</p>
            ...
            <!-- Employee Report -->
            <a href="{{ route('safety-communications.reports.employee') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow block">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-sm text-gray-600">Track individual employee communication receipt and acknowledgment.</p>
            ...
            <!-- Period Report -->
            <a href="{{ route('safety-communications.reports.period') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow block">
                <div class="flex items-center justify-between mb-4">
            ...
            <!-- Companies Report -->
            <a href="{{ route('safety-communications.reports.companies') }}" class="bg-white rounded-lg shadow p-6 hover:shadow-lg transition-shadow block">
                <div class="flex items-center justify-between mb-4">
                ...
                <p class="text-sm text-gray-600">Compare communication performance across parent and sister companies.</p>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">Filter by date range, department, employee, status, and more</p>
                    </div>
                </div>
            </div>
        </div>
