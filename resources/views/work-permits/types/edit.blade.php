...
@section('title', 'Edit Work Permit Type')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            <div class="flex items-center space-x-3">
                <a href="{{ route('work-permits.types.show', $workPermitType) }}" class="text-gray-500 hover:text-black">
                    <i class="fas fa-arrow-left mr-2"></i>Back
                </a>
                <h1 class="text-2xl font-bold text-black">Edit Work Permit Type</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <form action="{{ route('work-permits.types.update', $workPermitType) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white border border-gray-300 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="name" name="name" required value="{{ old('name', $workPermitType->name) }}"
                ...
                <div>
                    ...
                    <input type="text" id="code" name="code" required value="{{ old('code', $workPermitType->code) }}"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                    @error('code')
                        <p class="mt-1 text-sm text-[#CC0000]">{{ $message }}</p>
                    @enderror
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="description" name="description" rows="3"
                              class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">{{ old('description', $workPermitType->description) }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" id="default_validity_hours" name="default_validity_hours" required 
                           value="{{ old('default_validity_hours', $workPermitType->default_validity_hours) }}" min="1" max="168"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                ...
                <div>
                    ...
                    <input type="number" id="max_validity_hours" name="max_validity_hours" required 
                           value="{{ old('max_validity_hours', $workPermitType->max_validity_hours) }}" min="1" max="168"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                ...
                <div>
                    ...
                    <input type="number" id="approval_levels" name="approval_levels" required 
                           value="{{ old('approval_levels', $workPermitType->approval_levels) }}" min="1" max="5"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
            ...
            <div class="space-y-4">
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="requires_risk_assessment" value="1" {{ old('requires_risk_assessment', $workPermitType->requires_risk_assessment) ? 'checked' : '' }}
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="requires_jsa" value="1" {{ old('requires_jsa', $workPermitType->requires_jsa) ? 'checked' : '' }}
                               class="h-4 w-4 text-[#0066CC] focus:ring-[#0066CC] border-gray-300">
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="requires_gas_test" value="1" {{ old('requires_gas_test', $workPermitType->requires_gas_test) ? 'checked' : '' }}
                               class="h-4 w-4 text-[#0066CC] focus:ring-[#0066CC] border-gray-300">
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="requires_fire_watch" value="1" {{ old('requires_fire_watch', $workPermitType->requires_fire_watch) ? 'checked' : '' }}
                               class="h-4 w-4 text-[#0066CC] focus:ring-[#0066CC] border-gray-300">
                ...
                <div>
                    <label class="flex items-center">
                        <input type="checkbox" name="is_active" value="1" {{ old('is_active', $workPermitType->is_active) ? 'checked' : '' }}
                               class="h-4 w-4 text-[#0066CC] focus:ring-[#0066CC] border-gray-300">
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('work-permits.types.show', $workPermitType) }}" class="px-6 py-2 border border-gray-300 hover:bg-[#F5F5F5]">
                Cancel
            </a>
