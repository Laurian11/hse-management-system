...
@section('title', 'Create Stock Consumption Report')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            <div class="flex items-center space-x-3">
                ...
                <h1 class="text-2xl font-bold text-black">Create Stock Consumption Report</h1>
            </div>
        </div>
    </div>
</div>
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <form action="{{ route('procurement.stock-reports.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="bg-white border border-gray-300 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="item_category" name="item_category" value="{{ old('item_category') }}"
        ...
        <div class="bg-white border border-gray-300 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="number" id="opening_stock" name="opening_stock" step="0.01" min="0" value="{{ old('opening_stock') }}"
                           placeholder="0.00"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                    @error('opening_stock')
                        <p class="mt-1 text-sm text-[#CC0000]">{{ $message }}</p>
                ...
                <div>
                    ...
                    <input type="number" id="received_quantity" name="received_quantity" step="0.01" min="0" value="{{ old('received_quantity') }}"
                           placeholder="0.00"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                ...
                <div>
                    ...
                    <input type="number" id="consumed_quantity" name="consumed_quantity" step="0.01" min="0" value="{{ old('consumed_quantity') }}"
                           placeholder="0.00"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
        ...
        <div class="bg-white border border-gray-300 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="date" id="report_period_start" name="report_period_start" required value="{{ old('report_period_start') }}"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
                ...
                <div>
                    ...
                    <input type="date" id="report_period_end" name="report_period_end" required value="{{ old('report_period_end') }}"
                           class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">
        ...
        <div class="bg-white border border-gray-300 p-6">
            ...
            <div class="mt-6">
                ...
                <textarea id="consumption_details" name="consumption_details" rows="4"
                          ...
                          class="w-full px-3 py-2 border border-gray-300 focus:border-[#0066CC] focus:ring-1 focus:ring-[#0066CC]">{{ old('consumption_details') }}</textarea>
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('procurement.stock-reports.index') }}" class="px-6 py-2 border border-gray-300 hover:bg-gray-50">
                Cancel
            </a>
