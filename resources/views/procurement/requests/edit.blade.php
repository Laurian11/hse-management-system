    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center py-4">
            <div class="flex items-center space-x-3">
                <a href="{{ route('procurement.requests.show', $procurementRequest->id) }}" class="text-gray-500 hover:text-black">
...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <form action="{{ route('procurement.requests.update', $procurementRequest->id) }}" method="POST" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="flex justify-end space-x-3">
            <a href="{{ route('procurement.requests.show', $procurementRequest->id) }}" class="px-6 py-2 border border-gray-300 hover:bg-[#F5F5F5]">Cancel</a>
