    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white border border-gray-300 p-6">
                ...
                @php
                    $qrData = \App\Services\QRCodeService::forAuditRecord($audit->id, $audit->reference_number);
                ...
                <div class="text-center">
                    ...
                    <p class="text-xs text-gray-500 mb-2">Scan to view this audit</p>
            ...
            <div class="bg-white border border-gray-300 p-6">
                ...
                <div class="space-y-2">
                    ...
                    <a href="{{ route('qr.scanner') }}" class="block w-full text-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700">
